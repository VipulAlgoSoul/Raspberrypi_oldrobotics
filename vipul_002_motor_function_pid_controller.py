...
def motor_param_fun(distance,speed):
    global radius_actuator
    hole_count=(distance/(2*3.14*radius_actuator))/total_count_encoder_holes
    return hole_count

    

def motor_run_left(set_point,threshold_count,enable):
...
motor_run_left(set_point,500,1)
