...
def speed_of_motor():
    ...
    time_interval_min = time_interval*ratio_encoder
    speed = 60/((time_interval)*ratio_encoder)#find in rpm
    
    #time_array=np.append(time_array,time_prvs+time_interval)
    time_array=np.append(time_array,time_now-m)
    time_prvs=time_interval                     
    ...
    differential_error=((error-previous_error)/time_interval)*(time_now+time_interval)
    ...
    #correction =(prop_gain*(error**(0.5)))+ (derivative_gain*(differential_error**(0.5))) + (integral_gain*(integral_error**(0.5)))
...
print("kp",prop_gain,"   ","kd",derivative_gain,"  ","ki",integral_gain )
print("set_point",set_point)
print("max_peak_overshoot",max(speed_array))
print("max_error_overshoot",max(error_array))
print("max_error_in_ss",max(error_array[4:]))
...
plt.plot(time_array,speed_array,"k")
plt.plot(time_array,throttle_control_array,"b*")
plt.plot(time_array,throttle_control_array,"b")
plt.plot(time_array,set_point_array)
...
plt.plot(time_array,error_array,"ro")
plt.plot(time_array,error_array,"r")
plt.plot(time_array,np.zeros(size_of_array))
...
plt.plot(time_array,error_array,"ro")
plt.plot(time_array,error_array,"r")
plt.plot(time_array,differential_error_array,"b*")
plt.plot(time_array,differential_error_array,"b")
plt.plot(time_array,integral_error_array,"go")
plt.plot(time_array,integral_error_array,"g")
plt.plot(time_array,np.zeros(size_of_array))
plt.title("error variation proportional controller")
plt.xlabel("time_pseudo")
plt.ylabel("erro magnitude")
...
plt.plot(time_array,throttle_array,"r")
plt.plot(time_array,throttle_array,"ro")
plt.plot(time_array,throttle_control_array,"b*")
plt.plot(time_array,throttle_control_array,"b")
...
plt.plot(time_array,error_array,"r")
plt.plot(time_array,np.zeros(size_of_array))
plt.plot(time_array,throttle_array,"b")
plt.plot(time_array,throttle_array,"b*")
plt.plot(time_array,throttle_control_array,"g^")
plt.plot(time_array,throttle_control_array,"g")
...
plt.plot(time_array,error_array,"ro")
plt.plot(time_array,error_array,"r")
plt.plot(time_array,proportional_varied_array,"bo")
plt.plot(time_array,proportional_varied_array,"b")
plt.plot(time_array,np.zeros(size_of_array))
...
plt.plot(time_array,differential_error_array,"r*")
plt.plot(time_array,differential_error_array,"r")
plt.plot(time_array,differential_varied_array,"b*")
plt.plot(time_array,differential_varied_array,"b")
...
plt.subplot(2,3,4)
plt.plot(time_array,integral_error_array,"r*")
plt.plot(time_array,integral_error_array,"r")
plt.plot(time_array,np.zeros(size_of_array))
plt.plot(time_array,integral_varied_array,"b*")
plt.plot(time_array,integral_varied_array,"b")
plt.plot(time_array,np.zeros(size_of_array))
...
plt.plot(time_array,error_array,"ro")
plt.plot(time_array,error_array,"r")
plt.plot(time_array,PID_array,"g*")
plt.plot(time_array,PID_array,"g")
plt.title("comparison correction and actual ""alphabot"" proportional controller")
plt.xlabel("time_pseudo")
plt.ylabel("pwm applied")
